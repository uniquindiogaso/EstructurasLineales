package edu.uniquindio.gaso.ed.common;
...
public class Nodo<T> implements Comparable<T> {
	 ...
	 *            dato a almacenar
	 * @param siguiente
	 *            posicion siguiente a donde estara el dato
	 */
	 ...
	 *            posicion siguiente a donde estara el dato
	 * @param anterior
	 *            posicion anterior donde estara el dato
	 */
	...
	public int compareTo(T objeto) {
		return ((Comparable<T>) this.dato).compareTo(objeto);
	}
